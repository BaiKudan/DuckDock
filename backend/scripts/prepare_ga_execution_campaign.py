    ...
    *,
    ...
    return [
        ...
        _phase(
            ...
            outputs=["network_probe_report", "network_probe_signature", "network"],
        ...
        _phase(
            ...
            tools=["external assessment/signature", "collect_ga_independent_security.py"],
            outputs=[
